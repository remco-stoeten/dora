...
pub fn generate_bindings() -> Builder<tauri::Wry> {
    ...
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        db_commands::cloudflare_save_token,
        db_commands::cloudflare_list_accounts,
        db_commands::cloudflare_list_databases,
        db_commands::cloudflare_account,
        db_commands::cloudflare_disconnect,
        db_commands::cloudflare_is_connected,
