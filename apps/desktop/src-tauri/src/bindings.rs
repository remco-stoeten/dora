...
pub fn generate_bindings() -> Builder<tauri::Wry> {
    ...
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        db_commands::planetscale_save_token,
        db_commands::planetscale_account,
        db_commands::planetscale_list_databases,
        db_commands::planetscale_list_branches,
        db_commands::planetscale_create_password,
        db_commands::planetscale_disconnect,
        db_commands::planetscale_is_connected,
