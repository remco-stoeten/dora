                ...
                <div className="mx-auto grid max-w-5xl gap-4 sm:grid-cols-2">
                    {FEATURES.map(function (feature) {
                        ...
                        return (
                            <article
                                key={feature.slug}
                                className="border border-[#2b252c] bg-background/40 p-5 transition-colors hover:bg-[rgba(245,192,192,0.04)]"
                            >
                                <div className="mb-4 flex items-start gap-3">
                                    <span className="flex h-9 w-9 shrink-0 items-center justify-center border border-[#2b252c] text-[#ad8eb6]">
                                        <Icon className="h-4 w-4" aria-hidden />
                                    </span>
                                    <div>
                                        <h2 className="font-pixel text-lg font-medium text-foreground">
                                            <Link
                                                className="transition-colors hover:text-[#f5c0c0]"
                                ...
                                <Link
                                    className="mt-4 inline-flex text-sm text-[#ad8eb6] transition-colors hover:text-[#f5c0c0]"
                                    href={`/features/${feature.slug}`}
                                >
                                    Read more →
                                </Link>
