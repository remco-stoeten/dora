...
export const FEATURE_SHOWCASE_LABELS: Record<TFeatureDemo, string> = {
    'database-connection': 'Connection switcher and saved databases in Dora',
    'query-history':
        'Query history panel with replay, latency, and connection context',
    'schema-diagram': 'Live ER diagram with foreign keys and table metadata',
    'docker-containers':
    ...
    'ai-assistant': 'Schema-aware AI assistant generating reviewable SQL',
    'drizzle-runner':
